...
@section('title')   {{trans('geral.titulo_estoque_bebida')}}    @stop
@section('content')
...
<div class="row">
	<div id="breadcrumb" class="col-xs-12">
		<ol class="breadcrumb">
			...
			<li><a href="#">{{trans('geral.titulo_estoque_bebida')}}</a></li>
		...
		<div class="box">
			<div class="box-header">
				<div class="box-name">
					...
					<span>{{trans('geral.titulo_estoque_bebida')}}</span>
				</div>
			...
			<div class="box-content">
				<div id="tabs">
					<ul>
						<li><a href="{{url('panel-control/estoque-bebidas/cadastro')}}">{{trans('geral.tab_cadastro')}}</a></li>
						<li><a href="{{url('panel-control/estoque-bebidas/pesquisa')}}">{{trans('geral.tab_pesquisar')}}</a></li>
					</ul>
					<div id="tabs-2">
