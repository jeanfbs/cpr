...
{{Form::open(array('class' => 'form-horizontal ','id' => 'cadastro_estoque_bebidas'))}}
		<div class="form-group">
			<label class="col-sm-2 control-label">*{{trans('geral.menu_side_cardapio_bebidas')}}</label>
			<div class="col-sm-4">
...
<script src="{{url('js/estoques/bebidas/cadastro.js')}}" type="text/javascript" charset="utf-8"></script>
