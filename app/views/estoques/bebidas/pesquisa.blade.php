...
<form>
	<div class="form-group">
		<div class="col-xs-2">
	    	...
	    	<input type="text" class="form-control" id="min_b" >
	    </div>
	    <div class="col-xs-2">
	    	<label>{{trans('geral.max')}}</label>
	    	<input type="text" class="form-control" id="max_b">
	    </div>
	</div>
</form>
</div>
...
<div class="row">
	<div class="col-xs-12">
		<div class="box-content no-padding">
			<table class="table table-bordered table-striped table-hover" id="tabela_dados_estoque_bebida">
				<thead>
					<tr class="active">
						<th>{{trans('geral.codigo')}}</th>
						<th>{{trans('geral.menu_side_cardapio_bebidas')}}</th>
...
<!-- Modal -->
<div class="modal fade" id="editar_b" tabindex="-1" role="dialog" aria-labelledby="editar_b">
  <div class="modal-dialog devoops-modal" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        {{Form::open(array('class' => 'form-horizontal ','id' => 'edicao_estoque_bebida'))}}
		<div class="form-group">
	...
	{{Form::close()}}
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="salvar_edicao_b">{{trans('geral.button_salvar')}}</button>
      </div>
    </div>
  </div>
</div>
...
<script src="{{url('js/estoques/bebidas/pesquisa.js')}}"></script>
