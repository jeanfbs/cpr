...
@section('title')   {{trans('geral.titulo_categoria')}}    @stop
@section('content')
...
<div class="row">
	<div id="breadcrumb" class="col-xs-12">
		<ol class="breadcrumb">
			...
			<li><a href="#">{{trans('geral.titulo_categoria')}}</a></li>
		...
		<div class="box">
			<div class="box-header">
				<div class="box-name">
					...
					<span>{{trans('geral.titulo_categoria')}}</span>
				</div>
				<div class="box-icons pull-right">
					...
					<a href="{{url('panel-control/ajuda#categorias')}}">
			...
			<div class="box-content">
				<div id="tabs">
					<ul>
						<li><a href="{{url('panel-control/categorias/cadastro')}}">{{trans('geral.tab_cadastro')}}</a></li>
						<li><a href="{{url('panel-control/categorias/pesquisa')}}">{{trans('geral.tab_pesquisar')}}</a></li>
					</ul>
					<div id="tabs-2">
