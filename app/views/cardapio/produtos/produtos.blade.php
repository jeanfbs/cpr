...
@section('title')   {{trans('geral.titulo_produtos')}}    @stop
@section('content')
<!--Start Breadcrumb-->
<div class="row">
	<div id="breadcrumb" class="col-xs-12">
		<ol class="breadcrumb">
			...
			<li><a href="#">{{trans('geral.titulo_produtos')}}</a></li>
		...
		<div class="box">
			<div class="box-header">
				<div class="box-name">
					...
					<span>{{trans('geral.titulo_produtos')}}</span>
				</div>
				<div class="box-icons pull-right">
					...
					<a href="{{url('panel-control/ajuda#produtos')}}">
			...
			<div class="box-content">
				<div id="tabs">
					<ul>
						<li><a href="{{url('panel-control/produtos/cadastro')}}">{{trans('geral.tab_cadastro')}}</a></li>
						<li><a href="{{url('panel-control/produtos/pesquisa')}}">{{trans('geral.tab_pesquisar')}}</a></li>
					</ul>
					<div id="tabs-2">
