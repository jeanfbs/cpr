...
@section('title')   {{trans('geral.titulo_prato')}}    @stop
@section('content')
...
<div class="row">
	<div id="breadcrumb" class="col-xs-12">
		<ol class="breadcrumb">
			...
			<li><a href="#">{{trans('geral.titulo_prato')}}</a></li>
		...
		<div class="box">
			<div class="box-header">
				<div class="box-name">
					...
					<span>{{trans('geral.titulo_prato')}}</span>
				</div>
				<div class="box-icons pull-right">
					...
					<a href="{{url('panel-control/ajuda#pratos')}}">
			...
			<div class="box-content">
				<div id="tabs">
					<ul>
						<li><a href="{{url('panel-control/pratos/cadastro')}}">{{trans('geral.tab_cadastro')}}</a></li>
						<li><a href="{{url('panel-control/pratos/pesquisa')}}">{{trans('geral.tab_pesquisar')}}</a></li>
						<li><a href="{{url('panel-control/pratos-variedades')}}">{{trans('geral.tab_prato_variedade')}}</a></li>
						<li><a href="{{url('panel-control/pratos-categorias')}}">{{trans('geral.tab_prato_adicional')}}</a></li>
					</ul>
					<div id="tabs-2">
...
$(document).ready(function() {
	...
	$("#tabs").tabs({active: 1,cache: false});
